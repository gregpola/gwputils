...
public class Utilities {
     ...
     * @param parentSuffix Optional suffix to be added to the parent path
     ...
     * @param destinationDir The directory into which to extract the files
     * @param stripPrefix    Prefix to strip from the zip entry file path. null if not used
     ...
     * @param destination The destination directory tree to copy the tree to.  The subtree
...
/******************************************************************************/
    ...
    public static File findFile(File dir, String fileName) {
        Optional<File> searchResults = Stream.of(Objects.requireNonNull(dir.listFiles()))
