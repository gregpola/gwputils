...
/**
 * A class which implements a simple etched underline border which can
...
extends AbstractBorder {
   ...
   */
  public UnderlineBorder(int etchType) {
   ...
   */
  public UnderlineBorder(Color highlight, Color shadow)    {
   ...
   * @param shadow the color to use for the etched shadow
   */
  public UnderlineBorder(int etchType, Color highlight, Color shadow) {
