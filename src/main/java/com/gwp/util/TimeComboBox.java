 ...
 * <p>Description:  A combo box that allows the selection of a 24 hour time</p>
...
extends JComboBox {
  ...
  /**
   * Returns the amount of time selected in seconds after midnight
   *
   * @return
   */
  public long getTimeInSeconds() {
    int index = getSelectedIndex();
    return ( (long)index * 15L * 60L );
  }


  /**
   * Convenience method for default enable/disable behavior
   *
   * @param enabled
   */
  ...
  /**
   * Sets the currently selected time in seconds after midnight. The choice will be the largest with out going over
   * the given value
   *
   * @param time
   */
  public void setTimeInSeconds( long time ) {
    int index = (int) ( time / 15L / 60L );
